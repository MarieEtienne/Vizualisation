...
BibOptions(check.entries = FALSE,
           ...
           hyperlink = FALSE,
           dashed = FALSE)
myBib <- ReadBib("../resources/visu.bib", check = FALSE)
...
# All defaults
knitr::include_graphics("../resources/img/otter.jpg")
```
...
# All defaults
knitr::include_graphics("../resources/img/seal.jpg")
```
...
# All defaults
knitr::include_graphics("../resources/img/lion.jpg")
```
...
# All defaults
knitr::include_graphics("../resources/img/turtle.jpeg")
```
...
# All defaults
knitr::include_graphics("../resources/img/wolf.jpeg")
```
